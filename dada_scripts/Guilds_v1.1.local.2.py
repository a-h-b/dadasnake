...
Script usage: Guilds_v1.0.py [-h] [-otu OTU_file] [-output OUTPUT_TOTAL][-db] [-m] [-u]
...
with open(args.path_to_db, "r") as read_file:
...
p = range(1,11)
way_points = [int(total_length*(x/50.0)) for x in p]
############################################################################################
